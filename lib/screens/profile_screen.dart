...
import 'package:spark/widgets/folow_botton.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  getData() async {
    ...
    try {
      ...
      followers = usersSnap.data()!['followers'].length;
      following = usersSnap.data()!['following'].length;
      isFolowing = usersSnap
          .data()!['followers']
                            ...
                            child: Column(
                              children: [
                                Row(
                                  ...
                                  children: [
                                    buldStatColumn(postLen, 'Posts'),
                                    buldStatColumn(followers, 'followers'),
                                    buldStatColumn(following, 'following'),
                                  ],
                                ),
                                Row(
                                  mainAxisAlignment:
  ...
  Column buldStatColumn(int num, String label) {
    return Column(
